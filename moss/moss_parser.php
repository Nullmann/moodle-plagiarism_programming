...
class moss_parser {
     ...
     *
     * Input: the similarity report in the report directory (moodledata/temp/plagiarism_programming/<cmid>/<userid>
     * and the record in plagiarism_programming_reslt table
